...
c$omp parallel default(private) firstprivate(dx,na1,na2,na3,idxf,k)
c$omp& shared(fudge,phi,rhs)
      dx2=dx**2
      kp=mod(k,na3)+1
      km=mod(k+na3-2,na3)+1
...
c$omp&     firstprivate(na1,na2,na3,dx,k,ik,lsquare) shared(def,baj,u) 
      di2=1/dx**2
      kp=mod(k,na3)+1
      km=mod(k+na3-2,na3)+1
      singular=.false.
